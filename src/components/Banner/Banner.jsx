    ...
    return (
        <div className='lg:h-[max(620px,_calc(92vh-49px))] h-[1050px] relative w-full overflow-hidden' style={{
            ...
            <div className='lg:block hidden'>
                ...
                {/* wave image and movement by framer motion */}
                <motion.div
                    className="absolute inset-0 bg-cover bg-center z-20"
                    style={{ backgroundImage: "url('/assets/backgrounds/WaveLinesDesktop1.svg')", x: moveX }}
                    initial={{ x: "-40%" }}
                    animate={{ x: 0 }}
                    transition={{
                        type: "spring",
                ...
                {/* wave svg and movement by framer motion */}
                <div>
                    <motion.svg
                        className="absolute right-[30%] top-[-10%] z-50"
            ...
            {/*Banner for mobile and tablet view */}
